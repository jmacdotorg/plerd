...
Thus, with certain options enabled, Plerd can send webmentions to websites that your blog posts link to.

For the time being, you can consult the documentation of the C<plerdwatcher> and C<plerdall> programs for a list of Webmention-related options.
