...
Thus, with certain options enabled, Plerd can send webmentions to websites that your blog posts link to. Consult the documentation of the C<plerdwatcher> and C<plerdall> programs for details about Webmention-related options.
